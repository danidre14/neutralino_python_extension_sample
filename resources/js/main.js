...
const extensionId = "js.neutralino.sample.my_python_extension";
...
async function callPythonExtension() {
...
function onPythonExtensionResponse(evt) {
...
Neutralino.events.on("fromExtensionToApp", onPythonExtensionResponse);
